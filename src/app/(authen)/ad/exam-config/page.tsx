...
export default function ExamSetList() {
  ...
  return (
    <div className="w-full h-full bg-gray-50 p-6 flex flex-col gap-3">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl mt-1">{exams.length}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl mt-1">{exams.filter((e) => e.status === "active").length}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl mt-1">{exams.filter((e) => e.status === "inactive").length}</p>
              </div>
      ...
      <Card className="flex flex-1 min-h-0 gap-3 flex-col">
        {loadingExam ? (
          ...
          <>
            <CardHeader>
              <div className="flex items-center md:flex-row md:items-center md:justify-between gap-4">
                ...
                <Button size="sm" className="gap-0!" onClick={() => router.push(`${pathname}/upload-question`)}>
                  <Plus size={20}></Plus>
                  <span>Thêm mới</span>
                </Button>
              </div>
