        ...
        <div className="p-8 bg-gray-100 h-full w-full flex flex-col items-center gap-2 overflow-auto">
            ...
            >
                ...
                <div className="flex justify-between items-start text-center mb-8">
                    <div className="w-[45%]">
                        <h2 className="font-bold text-[13pt] uppercase">
                    ...
                    <div className="w-[50%]">
                        ...
                        <h2 className="font-bold text-[13pt]">
                ...
                <div className="text-center mb-10">
                    <h1 className="font-bold text-[16pt] uppercase mb-2">
                        Phiếu kết quả kiểm tra quy trình năm{" "}
                ...
                <div className="space-y-4 text-[13pt]">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="w-[48%] flex items-end">
                            <span>
                                Ngày sinh:{" "}
                                {formatDate(account!.dob!, "DD/MM/YYYY")}
                            </span>
                        </div>
                    </div>

                    <div className="flex items-end">
                        <span>Địa chỉ thường trú: {account?.address}</span>
                    </div>

                    <div className="flex items-end">
                        <span>Đơn vị: {account?.org}</span>
                    </div>
