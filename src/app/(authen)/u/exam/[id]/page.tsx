...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, TextCustom } from "@components";
                  ...
                  <Card className="sticky top-6">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="pt-4 border-t space-y-4">
                        ...
                        <Button onClick={handleStart} disabled={!agreed} size="base" className="w-full">
                          Bắt đầu làm bài
                        </Button>
                      </div>
                      ...
                      <div className="pt-4 border-t">
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <p className="text-xs text-gray-600 mb-2">Thông tin bài thi:</p>
                          <div className="space-y-1 text-sm">
                            <div className="flex justify-between">
                              <span className="text-gray-600">Mã đề:</span>
                              <span className="font-mono font-semibold">{examTest.examCode}</span>
                            </div>
                          </div>
                        </div>
                      </div>
